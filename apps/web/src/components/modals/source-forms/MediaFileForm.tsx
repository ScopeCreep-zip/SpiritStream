...
interface MediaFileFormProps {
  data: MediaFileSource;
  onChange: (data: MediaFileSource) => void;
  onBrowseFile: () => void;
}

export const MediaFileForm = React.memo(({ data, onChange, onBrowseFile }: MediaFileFormProps) => {
...
MediaFileForm.displayName = 'MediaFileForm';
