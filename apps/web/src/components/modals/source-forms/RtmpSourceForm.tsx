...
interface RtmpSourceFormProps {
  data: RtmpSource;
  onChange: (data: RtmpSource) => void;
}

export const RtmpSourceForm = React.memo(({ data, onChange }: RtmpSourceFormProps) => {
...
RtmpSourceForm.displayName = 'RtmpSourceForm';
