/**
 * Device Store
 * Hardware device discovery and caching for capture sources.
 *
 * Source CRUD operations live in profileStore (atomic state updates).
 * This store only handles device enumeration + cache.
 */
