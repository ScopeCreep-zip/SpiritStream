...
#[openapi(
    ...
    paths(
        ...
        v1_profile_activate,
        v1_profile_deactivate,
        // Auth / security / files handlers live at the crate root (not in
        // `v1/`), so reference them crate-qualified.
        crate::auth::auth_logout,
        crate::auth::confirm_token_issue,
        crate::auth::events_ticket_issue,
        crate::auth::security_revoke_all_sessions,
        crate::file_browser::files_browse,
        crate::file_browser::files_home,
        crate::file_browser::files_open,
        v1_profile_unlock,
        v1_profile_decrypt,
        v1_profile_lock,
    ...
    components(schemas(
        ...
        crate::auth::AuthLogoutResponse,
        crate::auth::RevokeAllSessionsResponse,
        crate::auth::ConfirmTokenRequest,
        crate::auth::ConfirmTokenResponse,
        crate::auth::EventTicketResponse,
        crate::file_browser::FileBrowseResponseWire,
        crate::file_browser::FileEntryWire,
        crate::file_browser::FileHomeResponseWire,
        crate::file_browser::OpenPathRequest,
        crate::FilesOpenResponse,
